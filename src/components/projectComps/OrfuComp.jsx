...
export const OrfuComp = () => {
  ...
  const frames = [factSheetFrame, infoPageFrame, recipeDetailsFrame, recipeSubFrame, storyFrame, storyOnlyFrame, surveyConceptFrame, toolkitConceptFrame];
  ...
  return (
    <section className="projectContent" id="orfu">
      ...
      <section className="l-pic-big-r-text">
        <p className="projectP" id="rfu1">
          The founder wanted to combine
          food and conversation to engender empathy; as we developed our ideas and
          methodologies, the idea shifted
          from being a magazine to being a website to more
          efficiently distribute individual parts of what would have been the
          magazine, such as featured articles, tips, and fact sheets; and to
          allow both user-generated content (through submitted recipes and
          stories about, for instance, connecting over food, or sharing an
          interesting food-related tale), and to allow users to easily connect
      ...
      <p>
        ...
        and a Tweet from the ORfU account. I am also proud of the custom search
      ...
      <p>
        ...
        back up as-is (with modern modifications) in the near future. You can
        visit an archived version of the site here:
        <br />
        <br />
        <a
